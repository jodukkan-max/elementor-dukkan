...
class Tools extends Settings_Page {
	...
	public static function can_user_rollback_versions() {
		// Rollback installs a stock build from downloads.wordpress.org, which would replace
		// this fork. Returning false also hides the Version Control tab and its Finder entry.
		return false;
	}
	...
	public function display_beta_tester(): bool {
		// The beta channel serves stock Elementor zips from wordpress.org, which would
		// replace this fork. See Beta_Testers::check_version().
		return false;
	}
}
